	...
	$.Shop.prototype = {
		init: function() {
		  ...
		  // Properties
			...
			this.cartPrefix = "Raden-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.currency = "SEK"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "kr"; // Currency symbol as textual string
			this.paypalCurrency = "SEK"; // PayPal's currency code
			this.paypalBusinessEmail = "sebastian.raden.it@gmail.com"; // Your Business PayPal's account email address
